...
void Buttons_Setup()
{
    ...
    Button_EmergencyStop_Left_ISR_ClearPending();
    Button_EmergencyStop_Left_ISR_StartEx(
        Button_EmergencyStop_Left_ISR_Handler);

    DEBUG_PRINT("Emergency Stop Button (Right) ISR Started \r\n");
    Button_EmergencyStop_Right_ISR_ClearPending();
    Button_EmergencyStop_Right_ISR_StartEx(
        Button_EmergencyStop_Right_ISR_Handler);
}
...
//=============================================================================
CY_ISR(Button_EmergencyStop_Right_ISR_Handler)
{
