...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x05u, 0x14u, 0x09u, 0x44u, 0x65u,
        0x76u, 0x69u, 0x63u, 0x65u, 0x20u, 0x49u, 0x6Eu,
        0x66u, 0x6Fu, 0x20u, 0x45u, 0x78u, 0x61u, 0x6Du,
        0x70u, 0x6Cu, 0x65u, 0x03u, 0x03u, 0x0Au, 0x18u,
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x0Cu, 0x08u, 0x44u, 0x65u, 0x76u, 0x69u, 0x63u,
        0x65u, 0x20u, 0x49u, 0x6Eu, 0x66u, 0x6Fu, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t scan_rsp_data[CY_BLE_MAX_SCAN_RSP_DATA_LEN] */ 
        0x0Du, /* uint8_t scan_rsp_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x8Fu] = {
    /* Device Name */
    (uint8_t)'D', (uint8_t)'e', (uint8_t)'v', (uint8_t)'i', (uint8_t)'c', (uint8_t)'e', (uint8_t)' ', (uint8_t)'I',
(uint8_t)'n', (uint8_t)'f', (uint8_t)'o', (uint8_t)' ', (uint8_t)'E', (uint8_t)'x', (uint8_t)'a', (uint8_t)'m',
(uint8_t)'p', (uint8_t)'l', (uint8_t)'e', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Eu] = {
    ...
    { 0x0015u, (void *)&cy_ble_attValues[33] }, /* Manufacturer Name String */
    { 0x0008u, (void *)&cy_ble_attValues[54] }, /* Model Number String */
    { 0x000Au, (void *)&cy_ble_attValues[62] }, /* Serial Number String */
    { 0x0022u, (void *)&cy_ble_attValues[72] }, /* Hardware Revision String */
    { 0x0009u, (void *)&cy_ble_attValues[106] }, /* Firmware Revision String */
    { 0x000Cu, (void *)&cy_ble_attValues[115] }, /* Software Revision String */
    { 0x0008u, (void *)&cy_ble_attValues[127] }, /* System ID */
    { 0x0001u, (void *)&cy_ble_attValues[135] }, /* IEEE 11073-20601 Regulatory Certification Data List */
    { 0x0007u, (void *)&cy_ble_attValues[136] }, /* PnP ID */
};
