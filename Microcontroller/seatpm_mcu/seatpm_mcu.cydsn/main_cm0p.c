...
uint8 g_goniometer_thigh_accel_Buffer[BUFFER_SIZE];
uint8 g_goniometer_shank_accel_Buffer[BUFFER_SIZE];
...
int main(void)
{
    ...
    InitializeGoniConfigs(&configs,
                          g_goniometer_thigh_accel_Buffer,
                          g_goniometer_shank_accel_Buffer);
